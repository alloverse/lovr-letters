...
local MobileKeyboard3 = {
  caps= false,
  canBeGrabbed= true
}
setmetatable(MobileKeyboard3, {__index=letters.Node})
local MobileKeyboard3_mt = {
  __index = MobileKeyboard3
}
...
function MobileKeyboard3:_createButtons()
